...
namespace AzerothVoices
{
    ...
    struct ChatRequest
    {
        ...
        bool naturalCommandCapable = false;
        uint64_t naturalCommandOwnerGuid = 0;
        std::vector<uint64_t> naturalCommandRecipientGuids;
        std::vector<std::string> naturalCommandAllowedActions;
