...
namespace AzerothVoices
{
    ...
    struct Config
    {
        ...
        uint32_t proximityInstanceScanSeconds = 15;
        uint32_t proximityOutdoorChance = 25;
        uint32_t proximityInstanceChance = 35;
        uint32_t proximityConversationChance = 40;
        uint32_t proximityMinimumSpeakers = 1;
        uint32_t proximityMaximumSpeakers = 2;
        uint32_t proximityMaximumLines = 4;
        uint32_t proximityTurnGapSeconds = 4;
        ...
        uint32_t proximityZoneFatigueDecayPercent = 50;
        ...
        uint32_t bossDialogueRepeatDelayMinimumSeconds = 30;
        uint32_t bossDialogueRepeatDelayMaximumSeconds = 60;
        uint32_t bossDialogueRepeatChance = 60;
        uint32_t bossDialogueRepeatChanceFloor = 10;
        uint32_t bossDialogueRepeatChanceDecayPercent = 50;
        uint32_t bossDialoguePresenceResetSeconds = 600;
        uint32_t bossDialogueDirectedReplyCooldownSeconds = 30;
        uint32_t bossDialogueMinimumWords = 3;
        ...
        uint32_t groupConversationChance = 35;
        ...
        uint32_t groupBossKillChance = 65;
        uint32_t groupBossKillCooldownSeconds = 300;
        uint32_t groupWipeChance = 70;
        ...
        uint32_t groupLootEpicChance = 75;
        uint32_t groupLootLegendaryChance = 95;
        uint32_t groupLootCooldownSeconds = 60;
        uint32_t groupQuestAcceptChance = 40;
        uint32_t groupQuestObjectiveChance = 30;
        uint32_t groupQuestObjectiveDebounceSeconds = 60;
        uint32_t groupQuestCompleteChance = 55;
        uint32_t groupQuestCooldownSeconds = 60;
        uint32_t groupSpellCastChance = 5;
        uint32_t groupSpellCastCooldownSeconds = 180;
        uint32_t groupLowHealthChance = 20;
        uint32_t groupLowHealthThresholdPercent = 25;
        uint32_t groupLowHealthCooldownSeconds = 120;
        uint32_t groupLowManaChance = 20;
        uint32_t groupLowManaThresholdPercent = 20;
        uint32_t groupLowManaCooldownSeconds = 180;
        uint32_t groupNearbyObjectChance = 15;
        uint32_t groupNearbyObjectScanSeconds = 60;
        uint32_t groupNearbyObjectCooldownSeconds = 300;
        uint32_t groupBotQuestionChance = 15;
        uint32_t groupBotQuestionScanSeconds = 60;
        uint32_t groupBotQuestionCooldownSeconds = 300;
        uint32_t groupPlayerFollowupChance = 25;
        uint32_t groupPlayerFollowupCooldownSeconds = 60;
        uint32_t groupZoneChangeChance = 40;
        uint32_t groupZoneChangeCooldownSeconds = 300;
        uint32_t groupIdleChance = 10;
        uint32_t groupIdleCooldownSeconds = 120;
        uint32_t raidBattleCryChance = 40;
        uint32_t raidBattleCryCooldownSeconds = 180;
        uint32_t raidMoraleChance = 30;
        uint32_t raidMoraleScanSeconds = 60;
        uint32_t raidMoraleCooldownSeconds = 300;
        uint32_t raidIdleChance = 10;
        uint32_t raidIdleScanSeconds = 60;
        uint32_t raidIdleCooldownSeconds = 120;

        bool guildChatterEnabled = true;
        uint32_t guildChatterScanSeconds = 60;
        uint32_t guildAmbientChance = 20;
        uint32_t guildAmbientCooldownSeconds = 120;
        ...
        uint32_t guildRecentSpeakerSuppressionSeconds = 300;
        uint32_t guildReplyDebounceSeconds = 8;
        bool guildLoginGreetingEnabled = true;
        uint32_t guildLoginGreetingChance = 50;
        uint32_t guildLoginGreetingCooldownSeconds = 300;

        bool memoryEnabled = true;
        uint32_t memoryRetentionDays = 90;
        uint32_t memoryMaximumPerPair = 30;
        uint32_t memoryCacheMaximumPairs = 1024;
        uint32_t memoryMaximumPromptItems = 4;
        uint32_t memoryMaximumPromptCharacters = 350;
        uint32_t memoryRecallChance = 50;
        uint32_t memoryFirstMetChance = 100;
        ...
        uint32_t memoryAchievementChance = 30;
